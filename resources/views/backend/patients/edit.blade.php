...
@section('content')
    <div class="container-fluid px-3 px-sm-4 px-lg-5">
        ...
        <div
            ...
            <div>
                <h2 class="fw-bold mb-1 text-dark" style="font-size: 20px; letter-spacing: -0.025em;">✏️ Edit Patient Profile</h2>
                <p class="text-muted mb-0" style="font-size: 13px;">Modify and synchronize clinical profile for {{ $patient->patient_unique_id }}.</p>
            </div>
        ...
        <form action="{{ route('patients.update', $patient->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
            @csrf
            @method('PUT')
